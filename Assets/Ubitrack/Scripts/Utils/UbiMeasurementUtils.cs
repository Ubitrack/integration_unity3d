...
namespace FAR{
	...
	public class UbiMeasurementUtils  {
        ...
        //Default value to UbiScaleFactor, changed when a SimpleFacade is found
        public static float UbiToUnityScaleFactor = 1000.0f;
        //Reference to the first found local SimpleFacade
        static UTFacade ubitrackSF;
